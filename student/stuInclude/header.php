       ...
       <div class="header">
        ...
        <div class="menu_nav">
         <ul>
          ...
          <li class="active"><a href="../studentProfile.php"><span>User Profile</span></a></li>
          <li><a href="../contact.php"><span>Contact Us</span></a></li>
		  <li><?php echo''; ?> <a href="../logout.php?q=studentProfile.php"><span class="glyphicon glyphicon-log-out" aria-hidden="true"></span>&nbsp;Log out</a></li>
        </ul>
      </div>
      <div class="clr"></div>
      <div class="slider">
