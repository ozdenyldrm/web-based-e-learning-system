<html>
    <head>
	  ...
	  <style>
		...
		#b2{position: absolute; top:860px; left: 500px;}
		#b3{position: absolute; top:860px; left: 300px;}
...
<!-- end navigation -->
     ...
     <div class="left_menu">
       ...
       <div class="sag_icerik">
		...
		<b><i><p><i class="fas fa-arrow-alt-circle-right"></i> Program to find the first occurrence of a character in a string. Fill in the blanks:</p></i></b>
...
int main(){
    ...
    toFind = getchar();<p id='satir-1'>    index = indexOf( <input type='text' id='43' class='cevap'> , toFind); <input class='sonuc' style='display:none' type='text' id='y-35' readonly>
    if(index == -1)
        printf("'%c' not found.", toFind);
    else
        printf("'%c' is found at index %d.", toFind, index); }
int indexOf(const char * str, const char toFind){
    int i = 0;<p id='satir-2'> while( <input type='text' id='44' class='cevap'> ){ <input class='sonuc' style='display:none' type='text' id='y-36' readonly>
        if(str[i] == toFind)
            return i;
        i++; }
    return -1; }   
