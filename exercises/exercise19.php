<html>
    <head>
	  ...
	  <style>
		...
		#b2{position: absolute; top:865px; left: 500px;}
		#b3{position: absolute; top:865px; left: 300px;}
...
<!-- end navigation -->
	 <div class="left_menu">
       ...
       <div class="sag_icerik">
		...
		<b><i><p><i class="fas fa-arrow-alt-circle-right"></i> Program to find second largest number in an array. Fill in the blanks:</p></i></b>
        <pre style="font-size:20px;">
#include &lt;limits.h&gt; // For INT_MIN
#define MAX_SIZE 1000 // Maximum array size
int main(){
	<p id='satir-1'>int <input type='text' id='37' class='cevap'> , size, i; <input class='sonuc' style='display:none' type='text' id='y-37' readonly>
    int max1, max2;
    ...
    max1 = max2 = INT_MIN;
    for(i=0; i < size; i++){ <p id='satir-2'>if( <input type='text' id='38' class='cevap'> > max1){ <input class='sonuc' style='display:none' type='text' id='y-38' readonly>
            max2 = max1;
            max1 = arr[i];
        }
