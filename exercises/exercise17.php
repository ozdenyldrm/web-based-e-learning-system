<html>
    <head>
	  ...
	  <style>
        ...
        .content{
			padding-left:130px; padding-top:100px; width:1114px; height:760px; 
		}
		#b2{position: absolute; top:850px; left: 500px;}
		#b3{position: absolute; top:850px; left: 300px;}
		#c1{position: relative; left:70;}
	  </style>
    </head>
...
<!-- end navigation -->
	 <div class="left_menu">
       ...
       <div class="sag_icerik">
		...
		<b><i><p><i class="fas fa-arrow-alt-circle-right"></i> Program to compare two string without using string library functions. Fill in the blanks:</p></i></b>
        <pre style="font-size:20px;">
#define MAX_SIZE 1000 // Maximum array size
int compare(char * str1, char * str2);
int main(){
<p id='satir-1'>    char int <input type='text' id='32' class='cevap'> ; <input class='sonuc' style='display:none' type='text' id='y-32' readonly>
    int res;
    ...
    if(res == 0){ printf("Both strings are equal."); }
    else if(res < 0){ printf("First string is lexicographically smaller than second."); }
    else{ printf("First string is lexicographically greater than second."); }
    return 0; }
<p id='satir-2'>int compare( <input type='text' id='33' class='cevap'> ) <input class='sonuc' style='display:none' type='text' id='y-33' readonly>
    int i = 0;<p id='satir-3'>    while( <input type='text' id='34' class='cevap'> ){ <input class='sonuc' style='display:none' type='text' id='y-34' readonly>
    ...
    return str1[i] - str2[i]; } 
		  ...
		  <a href="exercise7.php"><button type="button" class="btn btn-success" id="b2">Next Exercise <i class="fas fa-arrow-right"></i></button></a>
		  </center>
