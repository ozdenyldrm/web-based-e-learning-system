<html>
    <head>
	  ...
	  <style>
		...
		#b2{position: absolute; top:840px; left: 500px;}
		#b3{position: absolute; top:840px; left: 300px;}
		#c1{position:relative; top:20; left:70;}
	  </style>
    </head>
...
<!-- end navigation -->
     ...
     <div class="left_menu">
       ...
       <div class="sag_icerik">
		...
		<b><i><p><i class="fas fa-arrow-alt-circle-right"></i> Program to find power of a number using recursion. Fill in the blanks:</p></i></b>
        <br> <pre style="font-size:20px;">#include &lt;stdio.h&gt;
<p id='satir-1'><input type='text' id='30' class='cevap'> ; <input class='sonuc' style='display:none' type='text' id='y-30' readonly>
int main()
{
    double base, power;
    int expo;
    ...
    scanf("%d", &expo);<p id='satir-2'>    power = <input type='text' id='31' class='cevap'> ; <input class='sonuc' style='display:none' type='text' id='y-31' readonly>
