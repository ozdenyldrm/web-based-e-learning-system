...
<!-- end navigation -->
    ...
    <div class="left_menu">
       ...
       <div class="sag_icerik">
		...
		<b><i><p><i class="fas fa-arrow-alt-circle-right"></i> Fill in the blanks according to the output:</p></i></b>
        <br> <pre style="font-size:18px;">
       int main(){
        int ID = 500;
        int password = 000;
        printf("Plese Enter Your ID:\n ");
        scanf("%d", &amp; ID);
        <p id='satir-1' ><input type='text' id='26' class='cevap'> (ID) {  case 500: <input class='sonuc' style='display:none' type='text' id='y-26' readonly>
                printf("Enter your password:\n ");
                scanf("%d", &amp; password);
                switch (password){
                    <p id='satir-2' ><input type='text' id='27' class='cevap'> 000: <input class='sonuc' style='display:none' type='text' id='y-27' readonly>
                        printf("Welcome Dear Programmer\n");
                        break;
                    <p id='satir-3' ><input type='text' id='29' class='cevap'> : <input class='sonuc' style='display:none' type='text' id='y-29' readonly>
                        printf("incorrect password");
                        break; }
               <p id='satir-4' ><input type='text' id='28' class='cevap'> ; <input class='sonuc' style='display:none' type='text' id='y-28' readonly>
            default:
                printf("incorrect ID");
                break; }
       </pre>
