<html>
    <head>
	  ...
	  <style>
		...
		#b2{position: absolute; top:570px; left: 500px;}
		#b3{position: absolute; top:570px; left: 300px;}
   ...
   <!-- start navigation -->
    ...
    <ul class="nav justify-content-end">
        <li class="nav-item">
            ...
            echo '<a href="../logout1.php?logout" class="nav-link">Logout</a>';
...
#include< stdio.h >
  void main()
{
<p id='satir-1' ><input type='text' id='8' class='cevap'> age = 33; <input class='sonuc' style='display:none' type='text' id='y-8' readonly> </p>
<p id='satir-2' ><input type='text' id='10' class='cevap'> name[] = "James"; <input class='sonuc' style='display:none' type='text' id='y-10' readonly></p>
<p id='satir-3' >printf("<input type='text' id='17' class='cevap'> is %d years old.\n", name, age); <input class='sonuc' style='display:none' type='text' id='y-17' readonly>
