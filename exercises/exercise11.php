<html>
    <head>
	  ...
	  <style>
		...
		#b2{position: absolute; top:830px; left: 500px;}
		#b3{position: absolute; top:830px; left: 300px;}
...
int main(){
char grade = 'B';
    <p id='satir-1' ><input type='text' id='26' class='cevap'> (grade) { <input class='sonuc' style='display:none' type='text' id='y-26' readonly>
        <p id='satir-2' ><input type='text' id='27' class='cevap'> 'A' : <input class='sonuc' style='display:none' type='text' id='y-27' readonly>
            printf("Excellent!\n" );
            <p id='satir-3' ><input type='text' id='28' class='cevap'> ; <input class='sonuc' style='display:none' type='text' id='y-28' readonly>
        case 'B' :
        case 'C' :
            printf("You passed\n" );
            break;
        <p id='satir-4' ><input type='text' id='29' class='cevap'> : <input class='sonuc' style='display:none' type='text' id='y-29' readonly>
