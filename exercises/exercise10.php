<html>
    <head>
	  ...
	  <style>
		...
		#b2{position: absolute; top:810px; left: 500px;}
		#b3{position: absolute; top:810px; left: 300px;}
...
int main(){
   ...
   <p id='satir-1' ><input type='text' id='34' class='cevap'> i++){ <input class='sonuc' style='display:none' type='text' id='y-34' readonly>
         sum = 0;
         num = i;
         digits = (int) log10(num) + 1;
         <p id='satir-2' ><input type='text' id='35' class='cevap'> (num > 0){ <input class='sonuc' style='display:none' type='text' id='y-35' readonly>
            lastDigit = num % 10;
   ...
   return 0;
		  ...
		  <a href="exercise11.php"><button type="button" class="btn btn-success" id="b2">Next Exercise <i class="fas fa-arrow-right"></i></button></a>
		  </center>
