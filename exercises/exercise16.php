...
<!-- end navigation -->
     ...
     <div class="left_menu">
       ...
       <div class="sag_icerik">
		...
		<b><i><p><i class="fas fa-arrow-alt-circle-right"></i> Program to find sum of all even or odd numbers in given range using recursion. Fill in the blanks:</p></i></b>
        <br> <pre style="font-size:20px;">
#include &lt;stdio.h&gt;

<p id='satir-1'><input type='text' id='47' class='cevap'> ; <input class='sonuc' style='display:none' type='text' id='y-47' readonly>
...
int main(){
  ...
  return 0; }
<p id='satir-2'>int sumOfEvenOdd( <input type='text' id='48' class='cevap'> ){ <input class='sonuc' style='display:none' type='text' id='y-48' readonly>
    if(start > end)
        return 0;
    else<p id='satir-3'>    return (start + <input type='text' id='49' class='cevap'>(start + 2, end)); }<input class='sonuc' style='display:none' type='text' id='y-49' readonly>
       </pre>
